...
#include "AI/Tasks/BTTask_GuardWait.h"
#include "AI/PatrolPoint.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"

UBTTask_GuardWait::UBTTask_GuardWait()
{
	NodeName = "Guard Wait";
	bNotifyTick = true;
}

EBTNodeResult::Type UBTTask_GuardWait::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UBTTask_GuardWait::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
FString UBTTask_GuardWait::GetStaticDescription() const
{
